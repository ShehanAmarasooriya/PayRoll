...
{
    public class EstateProductionSQLHelper
    {
        ...
        //{
        //    strConnection = @"Data Source=" + dbdetails._server + ";Initial Catalog=" + dbdetails._dbName + ";Persist Security Info=True;User ID=" + dbdetails._username + ";password = " + dbdetails._password + ";";
        //    return strConnection;
        //}


        public EstateProductionSQLHelper()
        {
        ...
        public static string connectionstring()
        {
            strConnection = @"Data Source=" + dbdetails._server + ";Initial Catalog=" + dbdetails._company + "HeadOfficeAdmin" + ";Persist Security Info=True;User ID=" + dbdetails._username + ";password = " + dbdetails._password + ";";
            return strConnection;
        ...
        //public static string connectionstring()
        //{
        //    //strConnection = @"Data Source=.;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    strConnection = @"Data Source=sqlvss;Initial Catalog=MalwatteEstDataCapture;Persist Security Info=True;User ID=sa;password = pass1234;";
        ...
        //    //strConnection = @"Data Source=192.168.102.1;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    //strConnection = @"Data Source=sqlvss;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    return strConnection;
        //}
