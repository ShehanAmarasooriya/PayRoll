...
namespace DataAccess
{
    public class SQLHelperGL
    {
        ...
        //public static string connectionstring()
        //{
        //    //strConnection = @"Data Source=192.168.50.1;Initial Catalog=MadulsimaEstateGL;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    //strConnection = @"Data Source=192.168.50.2;Initial Catalog=MadulsimaEstateGL;Persist Security Info=True;User ID=sa;password = pass1234;";
        ...
        //    //strConnection = @"Data Source=.;Initial Catalog=MadulsimaEstateGL;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    //strConnection = @"Data Source=192.168.8.104\SQLEXPRESS2014;Initial Catalog=KotagalaEstateGL;Persist Security Info=True;User ID=sa;password = pass1234;";
        //    //strConnection = @"Data Source=192.168.8.104\MSSQLSERVER2014;Initial Catalog=KotagalaEstateGL;Persist Security Info=True;User ID=sa;password = pass1234;";
