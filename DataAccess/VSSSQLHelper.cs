...
namespace DataAccess
{
    public class VSSSQLHelper
    {
        ...
        {
            strConnection = @"Data Source=" + dbdetails._server + ";Initial Catalog="+ dbdetails._company + "FTSPayrollDB"+" ;Persist Security Info=True;User ID=" + dbdetails._username + ";password = " + dbdetails._password + ";";
    ...
    //    strConnection = @"Data Source=sqlvss;Initial Catalog=MalwattefEstDataCaptureHeadOfice;Persist Security Info=True;User ID=sa;password = pass1234;";
