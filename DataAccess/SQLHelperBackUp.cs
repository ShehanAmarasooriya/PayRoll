...
{
    public class SQLHelperBackUp
    {
        static string strConnection;
        public SQLHelperBackUp()
        {
        ...
        public static string connectionstring()
        {
            ...
            strConnection = @"Data Source=.;Initial Catalog=BPLChkDB;Persist Security Info=True;User ID=sa;password = pass1234;Connection Timeout=0;";
            //strConnection = @"Data Source=.;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
            //strConnection = @"Data Source=.\SQLEXPRESS;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
            //strConnection = @"Data Source=192.168.100.1;Initial Catalog=FTSPayrollDB;Persist Security Info=True;User ID=sa;password = pass1234;";
            //strConnection = @"Data Source=.\SQLEXPRESS;Initial Catalog=FTSPayrollDB_feb;Persist Security Info=True;User ID=sa;password = pass1234;";
